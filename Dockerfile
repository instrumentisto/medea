...
COPY crates/medea-coturn-telnet-client/Cargo.toml /app/crates/medea-coturn-telnet-client/
...
RUN mkdir -p crates/medea-macro/src/ && touch crates/medea-macro/src/lib.rs \
 && mkdir -p crates/medea-coturn-telnet-client/src/ && touch crates/medea-coturn-telnet-client/src/lib.rs \
