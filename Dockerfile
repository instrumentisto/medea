...
COPY crates/medea-coturn-telnet/Cargo.toml /app/crates/medea-coturn-telnet/
...
RUN mkdir -p crates/medea-macro/src/ && touch crates/medea-macro/src/lib.rs \
 && mkdir -p crates/medea-coturn-telnet/src/ && touch crates/medea-coturn-telnet/src/lib.rs \
