...
COPY crates/crate-version-grep/Cargo.toml /app/crates/crate-version-grep/
...
RUN mkdir -p crates/medea-macro/src/ && touch crates/medea-macro/src/lib.rs \
 && mkdir -p crates/crate-version-grep/src && touch crates/crate-version-grep/src/lib.rs \
