...
impl From<IceConnectionState> for PeerConnectionState {
    fn from(ice_con_state: IceConnectionState) -> Self {
        use IceConnectionState as From;
        match ice_con_state {
            From::New => Self::New,
            From::Checking => Self::Connecting,
            From::Connected | From::Completed => Self::Connected,
            From::Failed => Self::Failed,
            From::Disconnected => Self::Disconnected,
            From::Closed => Self::Closed,
        }
    }
}
