...
mod grpc {
    ...
    ///
    /// This entity just store file stems (for `api.proto`'s filename file stem
    /// is `api` for example) of all files from [`GRPC_DIR`] that have
    /// `.proto` extension.
