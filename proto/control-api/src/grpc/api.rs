...
impl WebRtcPublishEndpoint {
    ...
    // bool is_force_relay = 5;


    pub fn get_is_force_relay(&self) -> bool {
        self.is_force_relay
    }
    pub fn clear_is_force_relay(&mut self) {
        self.is_force_relay = false;
    }

    // Param is passed by value, moved
    pub fn set_is_force_relay(&mut self, v: bool) {
        self.is_force_relay = v;
    }
}
...
impl ::protobuf::Message for WebRtcPublishEndpoint {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.is_force_relay != false {
            os.write_bool(5, self.is_force_relay)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                    "is_force_relay",
                    |m: &WebRtcPublishEndpoint| { &m.is_force_relay },
                    |m: &mut WebRtcPublishEndpoint| { &mut m.is_force_relay },
                ));
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        unsafe {
            descriptor.get(|| {
                ...
                fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                    "is_force_relay",
                    |m: &WebRtcPlayEndpoint| { &m.is_force_relay },
                    |m: &mut WebRtcPlayEndpoint| { &mut m.is_force_relay },
                ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    _stop\x18\x04\x20\x01(\tR\x06onStop\x12$\n\x0eis_force_relay\x18\x05\x20\
    \x01(\x08R\x0cisForceRelay\"-\n\x03P2P\x12\t\n\x05NEVER\x10\0\x12\x0f\n\
    \x0bIF_POSSIBLE\x10\x01\x12\n\n\x06ALWAYS\x10\x02\"\x90\x01\n\x12WebRtcP\
    layEndpoint\x12\x0e\n\x02id\x18\x01\x20\x01(\tR\x02id\x12\x10\n\x03src\
    \x18\x02\x20\x01(\tR\x03src\x12\x19\n\x08on_start\x18\x03\x20\x01(\tR\
    \x07onStart\x12\x17\n\x07on_stop\x18\x04\x20\x01(\tR\x06onStop\x12$\n\
    \x0eis_force_relay\x18\x05\x20\x01(\x08R\x0cisForceRelay2\x9d\x01\n\nCon\
    trolApi\x125\n\x06Create\x12\x14.medea.CreateRequest\x1a\x15.medea.Creat\
    eResponse\x12+\n\x06Delete\x12\x10.medea.IdRequest\x1a\x0f.medea.Respons\
    e\x12+\n\x03Get\x12\x10.medea.IdRequest\x1a\x12.medea.GetResponseb\x06pr\
    oto3\
";
