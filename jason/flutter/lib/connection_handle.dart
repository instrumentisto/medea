...
final _getRemoteMemberId_Dart _getRemoteMemberId =
...
final _free_Dart _free =
    dl.lookupFunction<_free_C, _free_Dart>('ConnectionHandle__free');
...
class ConnectionHandle {
  ...
  String getRemoteMemberId() {
    return _getRemoteMemberId(ptr.getInnerPtr()).toDartString();
  }
