...
final _resolveOk = ffi.dl.lookupFunction<_resolveOk_C, _resolveOk_Dart>('DartFuture__resolve_ok');
final _resolveErr = ffi.dl.lookupFunction<_resolveErr_C, _resolveErr_Dart>('DartFuture__resolve_err');
...
void spawner(Object fut, Pointer resolver) {
  if (fut is Future) {
    ...
    throw Exception("Unexpected Object provided from Rust: " + fut.runtimeType.toString());
  }
}
