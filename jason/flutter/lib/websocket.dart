...
void linkWebSocketFunctions() {
  ffi.dl.lookupFunction<Void Function(Pointer), void Function(Pointer)>("register_WebSocketChannel__new")(
      Pointer.fromFunction<Handle Function(Pointer<Utf8>)>(newWs)
  );

  ffi.dl.lookupFunction<Void Function(Pointer), void Function(Pointer)>("register_WebSocketChannel__on_message")(
      Pointer.fromFunction<Void Function(Handle, Pointer)>(listenWs)
  );

  ffi.dl.lookupFunction<Void Function(Pointer), void Function(Pointer)>("register_WebSocketChannel__send")(
