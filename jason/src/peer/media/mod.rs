...
/// [`Muteable`] + [`TransceiverSide`].
pub trait MuteableTransceiverSide: Muteable + TransceiverSide {}

impl<T> MuteableTransceiverSide for T where T: Muteable + TransceiverSide {}
