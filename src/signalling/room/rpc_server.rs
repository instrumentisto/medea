...
use actix::{ActorTryFutureExt as _, Addr, Handler, WrapFuture};
    ...
    fn handle(
        ...
        Box::pin(
            maybe_send_on_join
                ...
                .and_then(|member, this, _| {
                    this.init_member_connections(&member).map_ok(
                        move |_, _, _| RpcConnectionSettings {
